...
function preload() {
    ...
    pocket2 = loadImage("sprites/net.jpg")
    pocket3 = loadImage("sprites/net.jpg")
    pocket4 = loadImage("sprites/net.jpg")
...
text("Score :" + score, 425, 15);
fill("white");
console.log(score);
if(gameState === "SERVE2"&&movable===false){
 Matter.Body.setPosition(striker.body, {x:300, y: 65}) 
 movable = true;

}
if(gameState==="SERVE1"&&movable===false){
Matter.Body.setPosition(striker.body,{x:300, y:525})
    movable=true; 
}

image(pocket1, 34,33, 50,50);
image(pocket2, 514, 33, 50, 50);
image(pocket3, 34, 510, 50, 50);
image(pocket4,514, 510, 50, 50);
...
function mouseDragged(){
    if((gameState==="SERVE1"||gameState==="SERVE2")&& movable===true){
...
function keyPressed(){
    ...
    console.log(striker.body)
      ...
      striker.body.position.x=striker.body.position.x-2   ;
    ...
    if(keyCode===88&&gameState==="SERVE2"){
        gameState= "PLAY1";
